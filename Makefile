#############################################################################
# Makefile for building: singularity-qt
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Jul 14 01:13:25 2014
# Project:  singularity-qt.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile singularity-qt.pro
#############################################################################
...
CXXFLAGS      = -pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -march=native -O2 -D_REENTRANT -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/tor -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -fstack-protector-all -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lminiupnpc /home/panda/projects/singularity/src/leveldb/libleveldb.a /home/panda/projects/singularity/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -levent -lz -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
$(TARGET): /home/panda/projects/singularity/src/leveldb/libleveldb.a /home/panda/projects/singularity/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h build/ui_intro.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: singularity-qt.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile singularity-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/singularity-qt0.1.0.0 || $(MKDIR) build/singularity-qt0.1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/singularity-qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/singularity-qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/chainparams.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/hash.h src/uint256.h src/serialize.h src/core.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/bloom.h src/mruset.h src/checkqueue.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/qt/walletview.h src/qt/walletstack.h src/qt/walletframe.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/paymentserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/txdb.h src/leveldb.h src/threadsafety.h src/limitedmap.h src/qt/splashscreen.h src/qt/intro.h src/scrypt.h src/sph_blake.h src/sph_groestl.h src/sph_keccak.h src/sph_bmw.h src/sph_jh.h src/sph_skein.h src/sph_types.h src/sph_echo.h src/sph_luffa.h src/sph_simd.h src/sph_cubehash.h src/sph_shavite.h src/hashgroestl.h src/hashskein.h src/sph_fugue.h src/sph_hamsi.h src/hashx13.h build/singularity-qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/singularity-qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/tor/address.c src/tor/addressmap.c src/tor/aes.c src/tor/backtrace.c src/tor/buffers.c src/tor/channel.c src/tor/channeltls.c src/tor/circpathbias.c src/tor/circuitbuild.c src/tor/circuitlist.c src/tor/circuitmux.c src/tor/circuitmux_ewma.c src/tor/circuitstats.c src/tor/circuituse.c src/tor/command.c src/tor/compat.c src/tor/compat_libevent.c src/tor/config.c src/tor/config_codedigest.c src/tor/confparse.c src/tor/connection.c src/tor/connection_edge.c src/tor/connection_or.c src/tor/container.c src/tor/control.c src/tor/cpuworker.c src/tor/crypto.c src/tor/crypto_curve25519.c src/tor/crypto_format.c src/tor/curve25519-donna.c src/tor/di_ops.c src/tor/directory.c src/tor/dirserv.c src/tor/dirvote.c src/tor/dns.c src/tor/dnsserv.c src/tor/entrynodes.c src/tor/ext_orport.c src/tor/fp_pair.c src/tor/geoip.c src/tor/hibernate.c src/tor/log.c src/tor/memarea.c src/tor/mempool.c src/tor/microdesc.c src/tor/networkstatus.c src/tor/nodelist.c src/tor/onion.c src/tor/onion_fast.c src/tor/onion_main.c src/tor/onion_ntor.c src/tor/onion_tap.c src/tor/policies.c src/tor/singularity.cpp src/tor/procmon.c src/tor/reasons.c src/tor/relay.c src/tor/rendclient.c src/tor/rendcommon.c src/tor/rendmid.c src/tor/rendservice.c src/tor/rephist.c src/tor/replaycache.c src/tor/router.c src/tor/routerlist.c src/tor/routerparse.c src/tor/routerset.c src/tor/sandbox.c src/tor/statefile.c src/tor/status.c src/tor/tor_util.c src/tor/torgzip.c src/tor/tortls.c src/tor/transports.c src/tor/util_codedigest.c src/alert.cpp src/chainparams.cpp src/version.cpp src/sync.cpp src/util.cpp src/hash.cpp src/netbase.cpp src/key.cpp src/script.cpp src/core.cpp src/main.cpp src/init.cpp src/net.cpp src/bloom.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/qt/walletview.cpp src/qt/walletstack.cpp src/qt/walletframe.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/paymentserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/leveldb.cpp src/txdb.cpp src/qt/splashscreen.cpp src/qt/intro.cpp src/scrypt.cpp src/scrypt-sse2.cpp src/blake.c src/bmw.c src/groestl.c src/jh.c src/keccak.c src/skein.c src/echo.c src/luffa.c src/simd.c src/cubehash.c src/fugue.c src/hamsi.c src/shavite.c build/singularity-qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui src/qt/forms/intro.ui build/singularity-qt0.1.0.0/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_af_ZA.ts src/qt/locale/bitcoin_ar.ts src/qt/locale/bitcoin_bg.ts src/qt/locale/bitcoin_bs.ts src/qt/locale/bitcoin_ca.ts src/qt/locale/bitcoin_ca_ES.ts src/qt/locale/bitcoin_cs.ts src/qt/locale/bitcoin_cy.ts src/qt/locale/bitcoin_da.ts src/qt/locale/bitcoin_de.ts src/qt/locale/bitcoin_el_GR.ts src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_eo.ts src/qt/locale/bitcoin_es.ts src/qt/locale/bitcoin_es_CL.ts src/qt/locale/bitcoin_et.ts src/qt/locale/bitcoin_eu_ES.ts src/qt/locale/bitcoin_fa.ts src/qt/locale/bitcoin_fa_IR.ts src/qt/locale/bitcoin_fi.ts src/qt/locale/bitcoin_fr.ts src/qt/locale/bitcoin_fr_CA.ts src/qt/locale/bitcoin_gu_IN.ts src/qt/locale/bitcoin_he.ts src/qt/locale/bitcoin_hi_IN.ts src/qt/locale/bitcoin_hr.ts src/qt/locale/bitcoin_hu.ts src/qt/locale/bitcoin_it.ts src/qt/locale/bitcoin_ja.ts src/qt/locale/bitcoin_la.ts src/qt/locale/bitcoin_lt.ts src/qt/locale/bitcoin_lv_LV.ts src/qt/locale/bitcoin_nb.ts src/qt/locale/bitcoin_nl.ts src/qt/locale/bitcoin_pl.ts src/qt/locale/bitcoin_pt_BR.ts src/qt/locale/bitcoin_pt_PT.ts src/qt/locale/bitcoin_ro_RO.ts src/qt/locale/bitcoin_ru.ts src/qt/locale/bitcoin_sk.ts src/qt/locale/bitcoin_sr.ts src/qt/locale/bitcoin_sv.ts src/qt/locale/bitcoin_th_TH.ts src/qt/locale/bitcoin_tr.ts src/qt/locale/bitcoin_uk.ts src/qt/locale/bitcoin_zh_CN.ts src/qt/locale/bitcoin_zh_TW.ts build/singularity-qt0.1.0.0/ && (cd `dirname build/singularity-qt0.1.0.0` && $(TAR) singularity-qt0.1.0.0.tar singularity-qt0.1.0.0 && $(COMPRESS) singularity-qt0.1.0.0.tar) && $(MOVE) `dirname build/singularity-qt0.1.0.0`/singularity-qt0.1.0.0.tar.gz . && $(DEL_FILE) -r build/singularity-qt0.1.0.0


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/panda/projects/singularity/src/leveldb/libleveldb.a; cd /home/panda/projects/singularity/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/panda/projects/singularity/src/leveldb/libleveldb.a: FORCE
	cd /home/panda/projects/singularity/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-pipe -fstack-protector-all -D_FORTIFY_SOURCE=2 -march=native -O2" libleveldb.a libmemenv.a

/home/panda/projects/singularity/build/build.h: FORCE
	cd /home/panda/projects/singularity; /bin/sh share/genbuild.sh /home/panda/projects/singularity/build/build.h
...
build/singularity.o: src/tor/singularity.cpp src/tor/singularity.h \
		src/util.h \
		src/uint256.h \
		src/netbase.h \
		src/serialize.h \
		...
		src/clientversion.h \
		src/compat.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/singularity.o src/tor/singularity.cpp
...
build/scrypt-sse2.o: src/scrypt-sse2.cpp src/scrypt.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/scrypt-sse2.o src/scrypt-sse2.cpp
